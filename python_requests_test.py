...
url_kaiguandeng= 'http://192.168.3.38:8081/kaiguandeng/kgd/'
# url_fangfeiduoge = 'http://192.168.3.174:8080/fangfeiduoge/ffdg/'
# url_fangfeizuocang = 'http://192.168.3.38:8081/fangfeizuocang/ffzc/'
...
while True:
    ...
    # print(r.content)
    print(r_kaiguandeng.content.decode("utf-8"))
