...
img2 = cv2.imread("/home/db/bing/django_tensorflow_server/test_img/yiziluoding.jpg")
...
# url= 'http://192.168.3.174:8080/kaiguandeng/base64/'
...
while True:
    r1 = requests.post(url, data=data_641)
    r2 = requests.post(url, data=data_642)
    # print(r.content)
    # print(r.content.decode("utf-8"))
