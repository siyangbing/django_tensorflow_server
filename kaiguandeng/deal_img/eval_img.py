...
saved_model_dir = './django_test/shiziluoding/saved_model'
...
class EvalImg():
    def __init__(self,img_size, show_rate):
...
if __name__ == '__main__':
    ...
    evalimg = EvalImg(img_size, show_rate)
    img_list = evalimg.read_img(img_path)
    y_list = evalimg.eval_img_list(img_list)
    result = evalimg.get_boxes_result(y_list)
